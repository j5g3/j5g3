...
test('Class.extend', function(assert) {
var
	Prop = function() {},
	I, inst
;
	Prop.prototype.source = true;
	I = j5g3.Class.extend(new Prop(), new Prop());

	inst = new I();
	assert.ok(!inst.source, 'not own properties are ignored.');
	assert.ok(!I.source, 'not own static properties are ignored');
});
...
var
	...
	img2 = j5g3.dom('IMG')
;
	a.equal('audio', j5g3.get_type(audio2));
