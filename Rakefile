...
task :default do
	`cat src/j5g3.js src/j5g3-collision.js src/j5g3-shapes.js src/j5fx.js src/j5g3-support.js >> build/j5g3-all.js`
	`cat build/j5g3-all.js src/j5g3-module-dbg.js >> build/j5g3-dbg-all.js`
end
